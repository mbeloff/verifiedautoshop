    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Verified Auto Shop, 46 Deshon St,
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Verified Auto Shop, accessible from
          <a
            href="https://www.verifiedautoshop.com"
            rel="external nofollow noopener"
            target="_blank"
            >www.verifiedautoshop.com</a
          >
        </p>
      </li>
      <li>
